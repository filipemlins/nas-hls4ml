...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 30 15:54:46 2020
...
#states: Accuracy, Resource, Usage //, Latency

# Resource  = reward (VALOR ATUAL - OBJETIVO)

# Accuracy = reward (VALOR ATUAL - OBJETIVO)
...
destination = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/model_z/0/hls4ml_prj/'
source = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/model_z/myproject_test.cpp'

factor = [1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 15000, 24000]

while ( not((resource <= resource_usage_obj) and (accuracy >= accuracy_obj) or EPISODES == 10) ):
    #acoes 
   ...
   # Y =  random.randint(0, 6) + 1 
    ...
    for R in range(0,4):            
        ...
        with open('model_z/0/hls4ml_prj/myproject_prj/solution1/syn/report/myproject_csynth.xml') as fd:
        ...
        if (resource < resource_usage_obj):  
            ...
            f=open('/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/model_z/0/hls4ml_prj/myproject_prj/solution1/csim/report/myproject_csim.log')
            lines=f.readlines()
...
np.savetxt('model_z/dic_all.csv', dic_all, delimiter=',', fmt='%d, %d, %.2f, %.2f, %.2f, %.2f, %d, %d')
if(len(dic_tested) > 0):
    np.savetxt('model_z/dic_tested.csv', dic_tested, delimiter=',', fmt='%.2f, %d, %d, %.2f, %.2f, %.2f,%.2f,%d, %d')