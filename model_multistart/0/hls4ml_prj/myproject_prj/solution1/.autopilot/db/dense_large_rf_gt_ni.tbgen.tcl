set moduleName dense_large_rf_gt_ni
...
set C_modelName {dense_large_rf_gt_ni}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 16 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 16 regular {array 16 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_product_fu_272", "Parent" : "0", "Child" : ["5"],
		"CDFG" : "product",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_product_fu_272.myproject_mul_mul_16s_16s_32_1_1_U6", "Parent" : "4"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2611", "Max" : "5939"}
	, {"Name" : "Interval", "Min" : "2611", "Max" : "5939"}
]}
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 11 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 11 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "outidx6", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "w7_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.b7_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.outidx6_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.w7_V_U", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2627", "Max" : "5955"}
	, {"Name" : "Interval", "Min" : "2627", "Max" : "5955"}
]}
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 11 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 13 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 13 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 13 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 10 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 10 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2371", "Max" : "5187"}
	, {"Name" : "Interval", "Min" : "2371", "Max" : "5187"}
]}
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 10 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 18 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 18 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 18 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 12 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 12 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 12 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 15 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 15 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 15 } } }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_product_fu_272", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			{"Name" : "a_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "w_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_product_fu_272.myproject_mul_mul_16s_16s_32_1_1_U7", "Parent" : "4"}]}
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 14 regular {array 32 { 1 3 } 1 1 }  }
	{ res_V int 14 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 5 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 14 } } }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2355", "Max" : "5171"}
	, {"Name" : "Interval", "Min" : "2355", "Max" : "5171"}
]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4163", "Max" : "8771"}
	, {"Name" : "Interval", "Min" : "4163", "Max" : "8771"}
]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4419", "Max" : "9539"}
	, {"Name" : "Interval", "Min" : "4419", "Max" : "9539"}
]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.w7_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.acc_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_product_fu_271", "Parent" : "0", "Child" : ["5"],
		"CDFG" : "product",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "w_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_product_fu_271.myproject_mul_mul_16s_16s_32_3_1_U7", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_lshr_32ns_6ns_32_2_1_U30", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4931", "Max" : "11075"}
	, {"Name" : "Interval", "Min" : "4931", "Max" : "11075"}
]}
