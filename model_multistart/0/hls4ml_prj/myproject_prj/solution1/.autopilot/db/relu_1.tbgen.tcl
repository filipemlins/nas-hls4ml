...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "20185", "EstimateLatencyMax" : "20185",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "20185", "Max" : "20185"}
	, {"Name" : "Interval", "Min" : "20185", "Max" : "20185"}
]}
...
set C_modelArgList {
	...
	{ res_V int 9 regular {array 6728 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	...
	res_V { ap_memory {  { res_V_address0 mem_address 1 13 }  { res_V_ce0 mem_ce 1 1 }  { res_V_we0 mem_we 1 1 }  { res_V_d0 mem_din 1 9 } } }
}
set moduleName relu_1
set isTaskLevelControl 1
set isCombinational 0
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 18 regular {array 6728 { 1 3 } 1 1 }  }
	{ res_V int 17 regular {array 6728 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 13 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 18 } } }
	res_V { ap_memory {  { res_V_address0 mem_address 1 13 }  { res_V_ce0 mem_ce 1 1 }  { res_V_we0 mem_we 1 1 }  { res_V_d0 mem_din 1 17 } } }
}
set moduleName relu_1
set isTaskLevelControl 1
set isCombinational 0
...
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 1 regular {array 6728 { 1 3 } 1 1 }  }
	{ res_V int 15 regular {array 6728 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "13457", "EstimateLatencyMax" : "13457",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "13457", "Max" : "13457"}
	, {"Name" : "Interval", "Min" : "13457", "Max" : "13457"}
]}
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 13 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 1 } } }
	res_V { ap_memory {  { res_V_address0 mem_address 1 13 }  { res_V_ce0 mem_ce 1 1 }  { res_V_we0 mem_we 1 1 }  { res_V_d0 mem_din 1 15 } } }
}
set moduleName relu_1
set isTaskLevelControl 1
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "26913", "EstimateLatencyMax" : "26913",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "26913", "Max" : "26913"}
	, {"Name" : "Interval", "Min" : "26913", "Max" : "26913"}
]}
