...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename table_out_V \
    op interface \
    ports { table_out_V_address0 { O 10 vector } table_out_V_ce0 { O 1 bit } table_out_V_we0 { O 1 bit } table_out_V_d0 { O 18 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'table_out_V'"
}
}
