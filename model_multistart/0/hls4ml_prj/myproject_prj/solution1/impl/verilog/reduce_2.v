...
reg   [2:0] tmp_18_reg_363;
wire   [1:0] i_3_fu_222_p2;
reg   [1:0] i_3_reg_370;
wire    ap_CS_fsm_state5;
wire   [0:0] exitcond_fu_216_p2;
wire   [0:0] tmp_19_fu_241_p1;
reg   [0:0] tmp_19_reg_380;
...
always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_1_fu_48 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd2) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_2_fu_52 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd3) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_3_fu_56 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd4) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_4_fu_60 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd5) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_5_fu_64 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd6) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_6_fu_68 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd7) & (1'b1 == ap_CS_fsm_state3))) begin
        left_7_V_7_fu_72 <= x_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_18_reg_363 == 3'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign right_1_V_1_fu_277_p3 = ((tmp_19_reg_380[0:0] === 1'b1) ? x_V_q0 : p_Val2_7_reg_108);

assign right_1_V_2_fu_284_p3 = ((tmp_19_reg_380[0:0] === 1'b1) ? p_Val2_s_reg_120 : x_V_q0);

assign tmp1_fu_291_p2 = (p_Val2_s_reg_120 + p_Val2_8_reg_436);

assign tmp_18_fu_172_p1 = i_reg_97[2:0];

assign tmp_19_fu_241_p1 = i2_reg_132[0:0];
