...
reg   [17:0] exp_table2_load_reg_498;
...
wire  signed [31:0] tmp_3_cast_cast_fu_217_p1;
reg  signed [31:0] tmp_3_cast_cast_reg_513;
...
reg  signed [17:0] exp_res_V_load_reg_536;
wire    ap_CS_fsm_state11;
wire    ap_CS_fsm_state12;
wire  signed [31:0] grp_fu_463_p2;
reg  signed [31:0] r_V_reg_546;
...
wire   [0:0] tmp_11_fu_280_p3;
wire   [0:0] p_Result_5_fu_264_p3;
wire   [0:0] rev_fu_288_p2;
wire   [1:0] tmp_6_fu_308_p4;
wire   [2:0] tmp_9_fu_323_p4;
...
wire  signed [13:0] grp_fu_463_p1;
reg   [16:0] ap_NS_fsm;
...
myproject_mul_mul_18s_14s_32_3_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 18 ),
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 32 ))
myproject_mul_mul_18s_14s_32_3_1_U94(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        p_Result_s_reg_555 <= grp_fu_463_p2[32'd30];
        r_V_reg_546 <= grp_fu_463_p2;
        tmp_10_reg_561 <= grp_fu_463_p2[32'd14];
    end
end
...
assign Range1_all_ones_fu_332_p2 = ((tmp_9_fu_323_p4 == 3'd7) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_338_p2 = ((tmp_9_fu_323_p4 == 3'd0) ? 1'b1 : 1'b0);

assign Range2_all_ones_fu_317_p2 = ((tmp_6_fu_308_p4 == 2'd3) ? 1'b1 : 1'b0);
...
assign grp_fu_463_p1 = tmp_3_cast_cast_reg_513;
...
assign p_Result_5_fu_264_p3 = r_V_reg_546[32'd28];

assign p_Result_6_fu_300_p3 = p_Val2_2_fu_274_p2[32'd13];

assign p_Val2_1_fu_255_p4 = {{r_V_reg_546[28:15]}};

assign p_Val2_2_fu_274_p2 = (p_Val2_1_fu_255_p4 + tmp_11_cast_fu_271_p1);
...
assign rev_fu_288_p2 = (tmp_11_fu_280_p3 ^ 1'd1);
...
assign tmp_11_cast_fu_271_p1 = tmp_10_reg_561;

assign tmp_11_fu_280_p3 = p_Val2_2_fu_274_p2[32'd13];

assign tmp_13_fu_344_p3 = r_V_reg_546[32'd29];

assign tmp_2_fu_213_p1 = y_V_2_reg_503;

assign tmp_3_cast_cast_fu_217_p1 = $signed(invert_table3_q0);

assign tmp_4_fu_184_p1 = i_reg_145;

assign tmp_5_fu_199_p1 = y_V_reg_488;

assign tmp_6_fu_308_p4 = {{r_V_reg_546[31:30]}};

assign tmp_7_fu_221_p2 = ((i3_reg_156 == 4'd10) ? 1'b1 : 1'b0);

assign tmp_8_fu_233_p1 = i3_reg_156;

assign tmp_9_fu_323_p4 = {{r_V_reg_546[31:29]}};
