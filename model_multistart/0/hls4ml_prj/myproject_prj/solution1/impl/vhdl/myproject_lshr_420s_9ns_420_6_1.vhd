...
entity myproject_lshr_420s_9ns_420_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 420;  --data bitwidth
      din1_WIDTH : INTEGER := 420;    --shift control bitwidth
      dout_WIDTH : INTEGER := 420;  --output bitwidth
...
end entity myproject_lshr_420s_9ns_420_6_1;
architecture rtl of myproject_lshr_420s_9ns_420_6_1 is
