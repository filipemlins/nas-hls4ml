...
entity myproject_lshr_56s_6ns_56_2_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 56;  --data bitwidth
      din1_WIDTH : INTEGER := 56;    --shift control bitwidth
      dout_WIDTH : INTEGER := 56;  --output bitwidth
...
end entity myproject_lshr_56s_6ns_56_2_1;
architecture rtl of myproject_lshr_56s_6ns_56_2_1 is
