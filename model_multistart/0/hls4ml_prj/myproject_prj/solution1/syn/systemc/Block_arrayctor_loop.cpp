...
const sc_lv<1> Block_arrayctor_loop::ap_ST_fsm_state1 = "1";
const sc_lv<32> Block_arrayctor_loop::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<16> Block_arrayctor_loop::ap_const_lv16_400 = "10000000000";
const sc_lv<16> Block_arrayctor_loop::ap_const_lv16_A = "1010";
...
void Block_arrayctor_loop::thread_const_size_in_1() {
    const_size_in_1 = ap_const_lv16_400;
}

void Block_arrayctor_loop::thread_const_size_in_1_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void Block_arrayctor_loop::thread_const_size_out_1() {
    const_size_out_1 = ap_const_lv16_A;
}

void Block_arrayctor_loop::thread_const_size_out_1_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
