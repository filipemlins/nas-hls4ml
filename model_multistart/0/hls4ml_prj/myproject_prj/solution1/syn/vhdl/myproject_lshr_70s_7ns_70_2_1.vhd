...
entity myproject_lshr_70s_7ns_70_2_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 70;  --data bitwidth
      din1_WIDTH : INTEGER := 70;    --shift control bitwidth
      dout_WIDTH : INTEGER := 70;  --output bitwidth
...
end entity myproject_lshr_70s_7ns_70_2_1;
architecture rtl of myproject_lshr_70s_7ns_70_2_1 is
