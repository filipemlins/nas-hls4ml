...
assign res_V_d0 = ((tmp_3_fu_78_p2[0:0] === 1'b1) ? tmp_15_fu_74_p1 : 11'd0);

assign tmp_15_fu_74_p1 = data_V_q0[10:0];

assign tmp_3_fu_78_p2 = (($signed(data_V_q0) > $signed(12'd0)) ? 1'b1 : 1'b0);
