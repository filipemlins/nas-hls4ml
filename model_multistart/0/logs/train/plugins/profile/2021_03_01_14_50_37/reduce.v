...
wire   [1:0] tmp_21_fu_242_p1;
reg   [1:0] tmp_21_reg_415;
...
wire   [17:0] agg_result_i_fu_298_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state6_on_subcall_done) & (1'b1 == ap_CS_fsm_state6))) begin
            ap_return_preg <= agg_result_i_fu_298_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        i_3_reg_371 <= i_3_fu_194_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i_4_reg_407 <= i_4_fu_230_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_376 == 2'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        left_3_V_1_fu_48 <= left_0_V_reg_135;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_376 == 2'd2) & (1'b1 == ap_CS_fsm_state3))) begin
        left_3_V_2_fu_52 <= left_0_V_reg_135;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_376 == 2'd3) & (1'b1 == ap_CS_fsm_state3))) begin
        left_3_V_3_fu_56 <= left_0_V_reg_135;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_376 == 2'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        left_3_V_fu_44 <= left_0_V_reg_135;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_21_reg_415 == 2'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        right_3_V_1_fu_64 <= right_0_V_reg_159;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_21_reg_415 == 2'd2) & (1'b1 == ap_CS_fsm_state5))) begin
        right_3_V_2_fu_68 <= right_0_V_reg_159;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_21_reg_415 == 2'd3) & (1'b1 == ap_CS_fsm_state5))) begin
        right_3_V_3_fu_72 <= right_0_V_reg_159;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_21_reg_415 == 2'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_224_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        tmp_21_reg_415 <= tmp_21_fu_242_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_fu_188_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_reg_376 <= tmp_fu_200_p1;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_state6_on_subcall_done) & (1'b1 == ap_CS_fsm_state6))) begin
        ap_return = agg_result_i_fu_298_p2;
    end else begin
...
assign agg_result_i_fu_298_p2 = (grp_reduce_1_fu_180_ap_return + grp_reduce_1_fu_172_ap_return);
...
always @ (*) begin
    ap_condition_278 = (~(ap_phi_mux_i_phi_fu_128_p4 == 3'd0) & ~(ap_phi_mux_i_phi_fu_128_p4 == 3'd2) & ~(ap_phi_mux_i_phi_fu_128_p4 == 3'd1));
end

always @ (*) begin
    ap_condition_283 = (~(tmp_40_t_fu_236_p2 == 3'd4) & ~(tmp_40_t_fu_236_p2 == 3'd6) & ~(tmp_40_t_fu_236_p2 == 3'd5));
end
...
assign tmp_21_fu_242_p1 = i2_reg_148[1:0];

assign tmp_40_t_fu_236_p2 = (i2_reg_148 ^ 3'd4);
