...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 10:19:49 2021
...
def create_model():
    ...
    model.add(Flatten())
    model.add(Dense(120, name='fc1', kernel_initializer='lecun_uniform', kernel_regularizer=l1(0.0001)))
    model.add(Activation(activation='relu', name='relu3'))
    model.add(Dense(84, name='fc2', kernel_initializer='lecun_uniform', kernel_regularizer=l1(0.0001)))
...
def resource_usage(path_csynth, dic_usage ):
        ...
        return dic_usage, AverageLatency
...
path = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/mnist/'
destination_test_cpp = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/mnist/0/hls4ml_prj/'
source_test_cpp = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/mnist/myproject_test.cpp'

source_tb_data = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/mnist/tb_data'
destination_tb_data = '/home/filipe/MEGA/GitHub/hls4ml-tutorial-master/mnist/0/hls4ml_prj/tb_data'

factor = [1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 15000, 24000]
path_csynth = 'mnist/0/hls4ml_prj/myproject_prj/solution1/syn/report/myproject_csynth.xml'
dic_usage = [0, 0, 0, 0]
